...
def pilih_super():
	...
	if peak =="":
		...
		jalan('\033[1;32mGetting IDs \033[1;97m...')
		...
		os.system('clear')
		print logo
		idt = raw_input("\033[1;32mEnter ID : ")
		try:
	...
	print "\033[1;32mTotal IDs : \033[1;94m"+str(len(id))
	jalan('\033[1;32mPlease Wait...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;32;40mCloning\033[1;93m"+o),;sys.stdout.flush();time.sleep(1)
	...
	print '\033[1;31;40mProcess Has Been Completed\033[1;96m....'
